...
import java.time.LocalDate; // Gunakan ini sebagai pengganti java.util.Date
...
public class Karyawan {
    ...
    private LocalDate tglLahir; // Langsung dikenali sebagai DATE tanpa @Temporal
    ...
    public Karyawan(String idKaryawan, String nama, String jenisKelamin, String alamat, String telepon, LocalDate tglLahir, Double gaji) {
    ...
    // Getter dan Setter tetap sama, hanya ganti tipe data Date menjadi LocalDate
